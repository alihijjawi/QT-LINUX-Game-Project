...
#include "../HassanAliProject/game1scene.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_game1scene_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_game1scene_t qt_meta_stringdata_game1scene = {
    {
QT_MOC_LITERAL(0, 0, 10), // "game1scene"
QT_MOC_LITERAL(1, 11, 11), // "mutexButton"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "returnToMenu"
QT_MOC_LITERAL(4, 37, 15) // "updateCountdown"

    },
    "game1scene\0mutexButton\0\0returnToMenu\0"
    "updateCountdown"
};
...
QT_INIT_METAOBJECT const QMetaObject game1scene::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_game1scene.data,
    qt_meta_data_game1scene,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *game1scene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_game1scene.stringdata0))
